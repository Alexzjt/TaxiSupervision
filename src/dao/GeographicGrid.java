...
public class GeographicGrid {
	...
	public String toStringGeographicCodeLonLat1LonLat2() {
		...
		strBuilder.append(",").append(lonLat.toString()).append(",").append(String.valueOf(lonLat.longitude + 0.0125)).append(",")
				.append(String.valueOf(lonLat.latitude + 0.0125 * 2.0 / 3.0));
		return strBuilder.toString();
	}
	...
	public String toStringLonLat1LonLat2() {
		StringBuilder strBuilder = new StringBuilder(lonLat.toString());
		strBuilder.append(",").append(String.valueOf(lonLat.longitude + 0.0125)).append(",")
				.append(String.valueOf(lonLat.latitude + 0.0125 * 2.0 / 3.0));
		return strBuilder.toString();
	}
