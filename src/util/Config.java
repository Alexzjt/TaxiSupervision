...
public class Config {
	...
	public static String PROVINCE_GRID="D:\\zjt\\网约车实验结果\\省级经纬度地理网格与行政区划\\"+PROVINCE+".csv";
	public static String PROVINCE_BOUNDARY_DIR="D:\\zjt\\区县边界经纬度\\chinaGridCode\\"+PROVINCE+"\\";
	public static String PROVINCE_MATCH="D:\\zjt\\网约车实验结果\\"+PROVINCE+"8位网格匹配"+DF.format(new Date())+".csv";
